...
import { FlatList, View, StyleSheet, TouchableOpacity, Text, Platform, TouchableWithoutFeedback} from 'react-native';
...
export default class MessageContainer extends React.PureComponent {
    ...
    render() {
        ...
        <FlatList
            ...
            style={styles.listStyle} contentContainerStyle={styles.contentContainerStyle}
