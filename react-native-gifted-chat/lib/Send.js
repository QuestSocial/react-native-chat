...
export const Send = ({ text = '', containerStyle, children, textStyle, label = 'Send', alwaysShowSend = false, disabled = false, sendButtonProps, onSend = () => { }, }) => {
    ...
    return (<TouchableOpacity testID={TEST_ID.SEND_TOUCHABLE} accessible accessibilityLabel='send' style={[
    {
        padding: 8,
        marginHorizontal: 12,
         ...
         <MaterialCommunityIcons name="send-outline" size={22} color="white" />
